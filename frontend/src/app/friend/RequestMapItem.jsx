...
const RequestMapItem = ({ data, borderBottom, reqId }) => {
  const [hovered, setHovered] = useState(false);

  const { rejectReq, acceptReq } = userFriendStore();
  ...
  return (
    ...
    >
      <Flex
        ...
        borderTop={borderBottom === true ? "0.5px solid" : "none"}
      ...
      >
        ...
        <Flex gap="10px">
          ...
          <Box
            ...
            _hover={{ bg: "gray.900" }}
          >
            <IoCheckmarkSharp className="iconMedium" />
          </Box>
        </Flex>
      </Flex>
    </Motion.div>
